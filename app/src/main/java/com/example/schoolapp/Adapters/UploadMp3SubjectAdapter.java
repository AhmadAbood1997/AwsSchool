...
import com.example.schoolapp.Views.Activities.UploadMp3CoursActivity;
import com.example.schoolapp.Views.Activities.UploadPdfCoursActivity;

import java.util.List;

public class UploadMp3SubjectAdapter extends RecyclerView.Adapter<ViewHolderInsertSubject> {
    private Context context;
    private List<Subject> subjects;
    public static String nameSubjectUploadMp3;

    public UploadMp3SubjectAdapter(Context context, List<Subject> subjects) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInsertSubject viewHolderInsertSubject, int position) {
        ...
        viewHolderInsertSubject.getView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nameSubjectUploadMp3 = subject.getName();

                Intent intent = new Intent(context, UploadMp3CoursActivity.class);
