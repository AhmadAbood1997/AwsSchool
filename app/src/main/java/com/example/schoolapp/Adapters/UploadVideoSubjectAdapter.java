...
public class UploadVideoSubjectAdapter extends RecyclerView.Adapter<ViewHolderInsertSubject> {
    private Context context;
    private List<Subject> subjects;
    public static String nameSubjectUploadVideo;

    public UploadVideoSubjectAdapter(Context context, List<Subject> subjects) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInsertSubject viewHolderInsertSubject, int position) {
        ...
        viewHolderInsertSubject.getView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nameSubjectUploadVideo = subject.getName();

                Intent intent = new Intent(context, UploadVideoCoursActivity.class);
