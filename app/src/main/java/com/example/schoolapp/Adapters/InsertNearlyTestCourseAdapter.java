...
public class InsertNearlyTestCourseAdapter extends RecyclerView.Adapter<ViewHolderInsertCourse> {
    private Context context;
    private List<Course> courses;
    public static String nameCourse;

    public InsertNearlyTestCourseAdapter(Context context, List<Course> courses) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInsertCourse viewHolderInsertCourse, int position) {
        ...
        viewHolderInsertCourse.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, UploadNearlyTestActivity.class);
