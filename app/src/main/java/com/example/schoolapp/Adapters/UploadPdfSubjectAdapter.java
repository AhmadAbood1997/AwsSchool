...
public class UploadPdfSubjectAdapter extends RecyclerView.Adapter<ViewHolderInsertSubject> {
    private Context context;
    private List<Subject> subjects;
    public static String nameSubjectUploadPdf;

    public UploadPdfSubjectAdapter(Context context, List<Subject> subjects) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInsertSubject viewHolderInsertSubject, int position) {
        ...
        viewHolderInsertSubject.getView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nameSubjectUploadPdf = subject.getName();

                Intent intent = new Intent(context, UploadPdfCoursActivity.class);
