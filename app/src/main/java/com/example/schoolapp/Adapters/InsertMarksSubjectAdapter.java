...
import com.example.schoolapp.Views.Activities.InsertMarksCourseActivity;
import com.example.schoolapp.Views.Activities.InsertNearlyTestCourseActivity;

import java.util.List;

public class InsertMarksSubjectAdapter extends RecyclerView.Adapter<ViewHolderInsertSubject> {
    private Context context;
    private List<Subject> subjects;
    public static String nameSubject;

    public InsertMarksSubjectAdapter(Context context, List<Subject> subjects) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInsertSubject viewHolderInsertSubject, int position) {
        ...
        viewHolderInsertSubject.getView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, InsertMarksCourseActivity.class);
