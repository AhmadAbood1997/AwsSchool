...
public class RetrivePdfCourseAdapter extends RecyclerView.Adapter<ViewHolderInsertCourse> {
    private Context context;
    private List<Course> courses;

    public static String retrivePdfNameCours;

    public RetrivePdfCourseAdapter(Context context, List<Course> courses) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInsertCourse viewHolderInsertCourse, int position) {
        ...
        viewHolderInsertCourse.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                retrivePdfNameCours = course.getNameCourse();

                Intent intent = new Intent(context, RetrivePdfActivity.class);
