...
public class UploadPdfCourseAdapter extends RecyclerView.Adapter<ViewHolderInsertCourse> {
    private Context context;
    private List<Course> courses;

    public static String uploadPdfNameCours;

    public UploadPdfCourseAdapter(Context context, List<Course> courses) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderInsertCourse viewHolderInsertCourse, int position) {
        ...
        viewHolderInsertCourse.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                uploadPdfNameCours = course.getNameCourse();
